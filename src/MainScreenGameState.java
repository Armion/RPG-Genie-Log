...
public class MainScreenGameState extends BasicGameState implements ComponentListener{
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
		this.game = game;
		this.background = new Image("main/resources/background/forest.png");
		...
		Image exit = new Image("resources/hud/Playnow.png");
		this.exitButton = new MouseOverArea(container, play, container.getWidth()/2 - play.getWidth()/2, (container.getHeight()/2)+100 - (play.getHeight()/2)+100, this);
	}
